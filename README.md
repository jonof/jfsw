...
2. Open _sw.xcodeproj_ from within the JFShadowWarrior source code's _xcode_ folder.
3. Select the 'JFShadowWarrior' target and then from the Product menu choose Run.
