...
struct grpfile grpfiles[] = {
	{ "Registered Version",		0x7545319F, 47536148, 0, NULL, NULL },
	{ "Shareware Version",		0x08A7FA1F, 26056769, 0, NULL, NULL },
	{ "Wanton Destruction (Addon)", 0xA9AAA7B7, 48698128, 0, NULL, NULL },
